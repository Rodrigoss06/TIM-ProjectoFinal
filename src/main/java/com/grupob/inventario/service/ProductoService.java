...
public class ProductoService {
    ...
    public ProductoService(
        ...
        PermisoChecker permisoChecker,
        Clock clock,
        GestorTransacciones txManager,
    ...
    public void registrar(Producto producto, Rol rolUsuario) {
        permisoChecker.requierePermiso(
            rolUsuario,
            PermisoChecker.Accion.REGISTRAR_PRODUCTO
        );
    ...
    public List<Producto> buscar(
        ...
        permisoChecker.requierePermiso(
            rolUsuario,
            PermisoChecker.Accion.BUSCAR_PRODUCTO
        );
    ...
    public void eliminar(String codigo, Rol rolUsuario) {
        permisoChecker.requierePermiso(
            rolUsuario,
            PermisoChecker.Accion.ELIMINAR_PRODUCTO
        );
    ...
    public List<Producto> listar(FiltroListado filtro, Rol rolUsuario) {
        permisoChecker.requierePermiso(
            rolUsuario,
            PermisoChecker.Accion.LISTAR_PRODUCTO
        );
        Objects.requireNonNull(filtro, "filtro no puede ser null");
        return txManager.soloLectura(() ->
            filtro.aplicarA(productoRepo.listarActivos())
        );
    }
    ...
    public void actualizar(Producto producto, Rol rolUsuario) {
        ...
        txManager.enTransaccion(() -> {
            Producto existente = productoRepo
            ...
            auditoriaService.registrar(
                rolUsuario.name(),
                TipoEvento.ACTUALIZAR_PRODUCTO,
                producto.getCodigo(),
    ...
    public boolean tieneMovimientosRecientes(String codigo) {
        Objects.requireNonNull(codigo, "codigo no puede ser null");
        return txManager.soloLectura(() ->
            movimientoRepo.tieneMovimientosRecientes(
                codigo,
                VENTANA_RECIENTE,
                clock
            )
    ...
    public List<Producto> buscarCombinada(
        ...
        return txManager.soloLectura(() ->
            productoRepo.buscarCombinada(codigo, nombre, categoria)
        );
    }
}
